...
class PostgreSQLConnector(basefunctions.DbConnector):
    ...
    def execute_many(self, query: str, param_list: List[List]) -> None:
        ...
        Uses psycopg2's executemany() for optimal bulk performance with PostgreSQL.
        ...
        ...     "INSERT INTO price_data VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        with self.lock:
            ...
            try:
                ...
                # Execute bulk operation using psycopg2's executemany
